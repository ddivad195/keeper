...
data class Configuration(val botOwner: Long = 394484823944593409,
    ...
    fun setup(guild: Guild) {
        ...
        val newConfiguration = GuildConfiguration("keeper!", everyone.idLong)
        ...
        guild.retrieveOwner().queue {
            it.user.sendPrivateMessage(
                    embed {
                        ...
                        description = "Thanks for using Keeper!"
                        color = infoColor

                        author {
                            val me = guild.jda.retrieveUserById(394484823944593409).complete()
